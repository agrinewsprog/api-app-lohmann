...
import { AdminWeightFlocksService } from './adminWeightFlocks.service';

export class AdminWeightFlocksController {
  private service: AdminWeightFlocksService;

  constructor() {
    this.service = new AdminWeightFlocksService();
  }
